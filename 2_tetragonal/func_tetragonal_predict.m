function [var_out] = func_tetragonal_predict(varargin)
%----------------------------------------------------------
fid             = varargin{1};
...
%     JJ = get_invariant_func(matG,0);
%     JJ_C = get_invariant_func(matG,1);
%     JJ_CC = get_invariant_func(matG,2);

JJ_temp = get_invariant_tetra2(matG,0);
JJ_C_temp = get_invariant_tetra2(matG,1);
JJ_CC_temp = get_invariant_tetra2(matG,2);
JJ = zeros(1,8);
JJ_C = zeros(6,8);
JJ_CC = zeros(6,6,8);
for tp = 1: 8

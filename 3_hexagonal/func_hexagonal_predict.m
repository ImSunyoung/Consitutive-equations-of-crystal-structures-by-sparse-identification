function [var_out] = func_hexagonal_predict(varargin)
%----------------------------------------------------------
fid             = varargin{1};
...
JJ_temp = get_invariant_hexa4(matG,0);
JJ_C_temp = get_invariant_hexa4(matG,1);
JJ_CC_temp = get_invariant_hexa4(matG,2);
JJ = zeros(1,9);
JJ_C = zeros(6,9);
JJ_CC = zeros(6,6,9);
for tp = 1:9
